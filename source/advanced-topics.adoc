...
both RHEL 9 and Fedora 42 using the following commands without ever having to
use different machines.

[source,bash]
----
$ mock -r centos-stream+epel-9-x86_64 ~/rpmbuild/SRPMS/cello-1.0-1.el7.src.rpm

$ mock -r fedora-42-x86_64 ~/rpmbuild/SRPMS/cello-1.0-1.el7.src.rpm
...
$ mock -r centos-stream+epel-9-x86_64 ~/rpmbuild/SRPMS/cello-1.0-1.fc41.src.rpm
INFO: mock.py version 6.1 starting (python version = 3.13.2, NVR = mock-6.1-1.fc41), args: /usr/libexec/mock/mock -r centos-stream+epel-9-x86_64 /root/rpmbuild/SRPMS/cello-1.0-1.fc41.src.rpm
...
Start: run
INFO: Start(/root/rpmbuild/SRPMS/cello-1.0-1.fc41.src.rpm)  Config(centos-stream+epel-9-x86_64)
Start: clean chroot
Finish: clean chroot
Mock Version: 6.1
...
INFO: Buildroot is handled by package management downloaded with a bootstrap image:
  ...
  python3-dnf-plugins-core-4.3.0-18.el9.noarch
  yum-4.14.0-23.el9.noarch
Start: dnf4 update
No matches found for the following disable plugin patterns: local, spacewalk, versionlock
CentOS Stream 9 - BaseOS                         24 kB/s |  19 kB     00:00    
CentOS Stream 9 - AppStream                     191 kB/s |  19 kB     00:00    
CentOS Stream 9 - CRB                           137 kB/s |  19 kB     00:00    
CentOS Stream 9 - Extras packages               280 kB/s |  21 kB     00:00    
Extra Packages for Enterprise Linux 9 - x86_64   68 kB/s |  35 kB     00:00    
Extra Packages for Enterprise Linux 9 - x86_64   23 MB/s |  23 MB     00:01    
Dependencies resolved.
================================================================================
 Package                      Architecture Version             Repository  Size
================================================================================
Upgrading:
 rpmautospec-rpm-macros       noarch       0.8.1-11.el9        epel        11 k
...
rpmautospec-rpm-macros-0.8.1-11.el9.noarch.rpm  615 kB/s |  11 kB     00:00    
--------------------------------------------------------------------------------
Total                                            20 kB/s |  11 kB     00:00     
...
Running transaction
  Preparing        :                                                        1/1 
  Upgrading        : rpmautospec-rpm-macros-0.8.1-11.el9.noarch             1/2 
  Cleanup          : rpmautospec-rpm-macros-0.8.1-1.el9.noarch              2/2 
  Running scriptlet: rpmautospec-rpm-macros-0.8.1-1.el9.noarch              2/2 
  Verifying        : rpmautospec-rpm-macros-0.8.1-11.el9.noarch             1/2 
  Verifying        : rpmautospec-rpm-macros-0.8.1-1.el9.noarch              2/2 

Upgraded:
  rpmautospec-rpm-macros-0.8.1-11.el9.noarch                                    
...
Finish: dnf4 update
Finish: chroot init
Start: build phase for cello-1.0-1.fc41.src.rpm
Start: build setup for cello-1.0-1.fc41.src.rpm
Building target platforms: x86_64
Building for target x86_64
setting SOURCE_DATE_EPOCH=1736467200
Wrote: /builddir/build/SRPMS/cello-1.0-1.el9.src.rpm
No matches found for the following disable plugin patterns: local, spacewalk, versionlock
Last metadata expiration check: 0:00:41 ago on Fri May  2 11:47:16 2025.
...
Installing dependencies:
 annobin               x86_64    12.92-2.el9                 appstream    1.1 M
 cpp                   x86_64    11.5.0-5.el9                appstream     11 M
 gcc-plugin-annobin    x86_64    11.5.0-5.el9                appstream     40 k
 glibc-devel           x86_64    2.34-187.el9                appstream     35 k
 glibc-headers         x86_64    2.34-187.el9                appstream    542 k
 kernel-headers        x86_64    5.14.0-580.el9              appstream    1.9 M
 ...
 llvm-filesystem       x86_64    20.1.1-3.el9                appstream     11 k
 llvm-libs             x86_64    20.1.1-3.el9                appstream     55 M
...
Downloading Packages:
[SKIPPED] libedit-3.1-38.20210216cvs.el9.x86_64.rpm: Already downloaded        
[SKIPPED] annobin-12.92-2.el9.x86_64.rpm: Already downloaded                   
[SKIPPED] cpp-11.5.0-5.el9.x86_64.rpm: Already downloaded                      
[SKIPPED] gcc-11.5.0-5.el9.x86_64.rpm: Already downloaded                      
[SKIPPED] gcc-plugin-annobin-11.5.0-5.el9.x86_64.rpm: Already downloaded       
[SKIPPED] glibc-devel-2.34-187.el9.x86_64.rpm: Already downloaded              
[SKIPPED] glibc-headers-2.34-187.el9.x86_64.rpm: Already downloaded            
[SKIPPED] kernel-headers-5.14.0-580.el9.x86_64.rpm: Already downloaded         
[SKIPPED] libmpc-1.2.1-4.el9.x86_64.rpm: Already downloaded                    
[SKIPPED] libxcrypt-devel-4.4.18-3.el9.x86_64.rpm: Already downloaded          
[SKIPPED] llvm-filesystem-20.1.1-3.el9.x86_64.rpm: Already downloaded          
[SKIPPED] llvm-libs-20.1.1-3.el9.x86_64.rpm: Already downloaded                
Running transaction check
Transaction check succeeded.
Running transaction test
Transaction test succeeded.
Running transaction
  Preparing        :                                                        1/1 
  Installing       : libmpc-1.2.1-4.el9.x86_64                             1/12 
  Installing       : cpp-11.5.0-5.el9.x86_64                               2/12 
  Installing       : llvm-filesystem-20.1.1-3.el9.x86_64                   3/12 
  Installing       : kernel-headers-5.14.0-580.el9.x86_64                  4/12 
  Installing       : glibc-headers-2.34-187.el9.x86_64                     5/12 
  Installing       : libxcrypt-devel-4.4.18-3.el9.x86_64                   6/12 
  Installing       : glibc-devel-2.34-187.el9.x86_64                       7/12 
  Installing       : gcc-11.5.0-5.el9.x86_64                               8/12 
  Running scriptlet: gcc-11.5.0-5.el9.x86_64                               8/12 
  Installing       : libedit-3.1-38.20210216cvs.el9.x86_64                 9/12 
  Installing       : llvm-libs-20.1.1-3.el9.x86_64                        10/12 
  Installing       : annobin-12.92-2.el9.x86_64                           11/12 
  Running scriptlet: annobin-12.92-2.el9.x86_64                           11/12 
  Installing       : gcc-plugin-annobin-11.5.0-5.el9.x86_64               12/12 
  Running scriptlet: gcc-plugin-annobin-11.5.0-5.el9.x86_64               12/12 
  Verifying        : libedit-3.1-38.20210216cvs.el9.x86_64                 1/12 
  Verifying        : annobin-12.92-2.el9.x86_64                            2/12 
  Verifying        : cpp-11.5.0-5.el9.x86_64                               3/12 
  Verifying        : gcc-11.5.0-5.el9.x86_64                               4/12 
  Verifying        : gcc-plugin-annobin-11.5.0-5.el9.x86_64                5/12 
  Verifying        : glibc-devel-2.34-187.el9.x86_64                       6/12 
  Verifying        : glibc-headers-2.34-187.el9.x86_64                     7/12 
  Verifying        : kernel-headers-5.14.0-580.el9.x86_64                  8/12 
  Verifying        : libmpc-1.2.1-4.el9.x86_64                             9/12 
  Verifying        : libxcrypt-devel-4.4.18-3.el9.x86_64                  10/12 
  Verifying        : llvm-filesystem-20.1.1-3.el9.x86_64                  11/12 
  Verifying        : llvm-libs-20.1.1-3.el9.x86_64                        12/12 

Installed:
  annobin-12.92-2.el9.x86_64            cpp-11.5.0-5.el9.x86_64                
  gcc-11.5.0-5.el9.x86_64               gcc-plugin-annobin-11.5.0-5.el9.x86_64 
  glibc-devel-2.34-187.el9.x86_64       glibc-headers-2.34-187.el9.x86_64      
  kernel-headers-5.14.0-580.el9.x86_64  libedit-3.1-38.20210216cvs.el9.x86_64  
  libmpc-1.2.1-4.el9.x86_64             libxcrypt-devel-4.4.18-3.el9.x86_64    
  llvm-filesystem-20.1.1-3.el9.x86_64   llvm-libs-20.1.1-3.el9.x86_64          

Complete!
Finish: build setup for cello-1.0-1.fc41.src.rpm
Start: rpmbuild cello-1.0-1.fc41.src.rpm
Start: Outputting list of installed packages
Finish: Outputting list of installed packages
Building target platforms: x86_64
Building for target x86_64
setting SOURCE_DATE_EPOCH=1736467200
Executing(%prep): /bin/sh -e /var/tmp/rpm-tmp.yRJNUe
+ umask 022
...
++ jobs -p
+ exit 0
Executing(%build): /bin/sh -e /var/tmp/rpm-tmp.rK9pBS
+ umask 022
+ cd /builddir/build/BUILD
+ cd cello-1.0
...
++ jobs -p
+ exit 0
Executing(%install): /bin/sh -e /var/tmp/rpm-tmp.3Ooh9Y
+ umask 022
+ cd /builddir/build/BUILD
+ '[' /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64 '!=' / ']'
+ rm -rf /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64
++ dirname /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64
+ mkdir -p /builddir/build/BUILDROOT
+ mkdir /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64
+ cd cello-1.0
+ /usr/bin/make install DESTDIR=/builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64 'INSTALL=/usr/bin/install -p'
mkdir -p /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64/usr/bin
install -m 0755 cello /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64/usr/bin/cello
+ /usr/bin/find-debuginfo -j1 --strict-build-id -m -i --build-id-seed 1.0-1.el9 --unique-debug-suffix -1.0-1.el9.x86_64 --unique-debug-src-base cello-1.0-1.el9.x86_64 --run-dwz --dwz-low-mem-die-limit 10000000 --dwz-max-die-limit 110000000 --remove-section .gnu.build.attributes -S debugsourcefiles.list /builddir/build/BUILD/cello-1.0
extracting debug info from /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64/usr/bin/cello
original debug info size: 16kB, size after compression: 16kB
...
Processing files: cello-1.0-1.el9.x86_64
Executing(%license): /bin/sh -e /var/tmp/rpm-tmp.vSQTAo
+ umask 022
+ cd /builddir/build/BUILD
+ cd cello-1.0
+ LICENSEDIR=/builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64/usr/share/licenses/cello
+ export LC_ALL=C
+ LC_ALL=C
+ export LICENSEDIR
+ /usr/bin/mkdir -p /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64/usr/share/licenses/cello
+ cp -pr LICENSE /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64/usr/share/licenses/cello
+ RPM_EC=0
++ jobs -p
+ exit 0
Provides: cello = 1.0-1.el9 cello(x86-64) = 1.0-1.el9
...
Provides: cello-debuginfo = 1.0-1.el9 cello-debuginfo(x86-64) = 1.0-1.el9 debuginfo(build-id) = 2d62b7991636eba9114f53dc965bca71d75c2793
Requires(rpmlib): rpmlib(CompressedFileNames) <= 3.0.4-1 rpmlib(FileDigests) <= 4.6.0-1 rpmlib(PayloadFilesHavePrefix) <= 4.0-1
Recommends: cello-debugsource(x86-64) = 1.0-1.el9
Checking for unpackaged file(s): /usr/lib/rpm/check-files /builddir/build/BUILDROOT/cello-1.0-1.el9.x86_64
Wrote: /builddir/build/RPMS/cello-1.0-1.el9.x86_64.rpm
Wrote: /builddir/build/RPMS/cello-debuginfo-1.0-1.el9.x86_64.rpm
Wrote: /builddir/build/RPMS/cello-debugsource-1.0-1.el9.x86_64.rpm
Finish: rpmbuild cello-1.0-1.fc41.src.rpm
Finish: build phase for cello-1.0-1.fc41.src.rpm
INFO: Done(/root/rpmbuild/SRPMS/cello-1.0-1.fc41.src.rpm) Config(centos-stream+epel-9-x86_64) 1 minutes 41 seconds
...
https://github.com/rpm-software-management/dnf[dnf] output (depending on RHEL9,
CentOS-Stream, or Fedora mock target) that is not found in this output which was
omitted for brevity and is often omitted after you have done an ``--init`` on a
mock target, such as ``mock -r centos-stream+epel-9-x86_64 --init`` which will pre-download
...
https://fedoraproject.org/wiki/EPEL[EPEL] repository for use on RHEL 9 and
CentOS-Stream.
...
$ tito build --builder=mock --arg mock=centos-stream+epel-9-x86_64 --test --rpm
Building package [dist-git-0.13-1]
Creating rpms for dist-git-git-0.efa5ab8 in mock: centos-stream+epel-9-x86_64
Wrote: /tmp/tito/dist-git-git-0.efa5ab8.tar.gz
...
(available in EPEL for RHEL 9 and CentOS-Steam), we have a number of python2
...
One example of this kind of RPMs would be for https://www.python.org/[Python]
version 2.x and if we have the ``python2-rpm-macros`` package installed
(available in EPEL for RHEL 9), we have a number of python2 specific macros
available to us.
endif::rhel[]
...
``/usr/share/doc/rpm-4.*/triggers`` on RHEL 9 and CentOS-Stream systems.
endif::community[]
